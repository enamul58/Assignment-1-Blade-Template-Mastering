    ...
    <section class="py-12">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <!-- Featured Post -->
            @foreach($featuredPosts as $singlePost)
            ...
            <div class="p-6">
              <div class="flex items-center text-sm text-gray-500 mb-2">
                ...
                <span
                  ...
                  >{{$singlePost->feature}}</span
                >
                
                <span class="mx-2">•</span>
                <span>{{$singlePost->postDate}}</span>
                <span class="mx-2">•</span>
    ...
    <div class="container mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <div class="space-y-8">
          ...
          >
            ...
            <div class="p-6 md:w-2/3">
              ...
              <h3 class="text-xl font-bold mb-2 text-gray-800">
                React 18: What's New and Improved
              </h3>
              <p class="text-gray-600 mb-4">
                Discover the exciting new features and improvements in React 18
          ...
          >
            ...
            <div class="p-6 md:w-2/3">
              ...
              <p class="text-gray-600 mb-4">
                Key security practices every developer should implement to
          ...
          >
            ...
            <div class="p-6 md:w-2/3">
              ...
              <p class="text-gray-600 mb-4">
                How low-code platforms are changing the software development
                landscape and who should use them.
              </p>
              <a
                href="#"
                class="text-blue-600 font-medium hover:text-blue-800 transition"
      ...
      <aside class="lg:w-1/3 space-y-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow">
          ...
          <p class="text-gray-600 mb-4">
            IBlog brings you the latest news, tutorials, and thought pieces on
            technology, programming, AI, and the digital world.
          </p>
          <button
            class="text-blue-600 font-medium hover:text-blue-800 transition"
          >
